...
use ProxyManagerLts\Proxy\LazyLoadingInterface;
use ProxyManagerLts\ProxyGenerator\Util\Properties;
use ProxyManagerLtsTestAsset\BaseClass;
use ProxyManagerLtsTestAsset\CallableInterface;
...
use ProxyManagerLtsTestAsset\ClassWithDynamicArgumentsMethod;
...
use ProxyManagerLtsTestAsset\ClassWithMixedPropertiesAndAccessorMethods;
...
/**
 * Tests for {@see \ProxyManagerLts\ProxyGenerator\LazyLoadingGhostGenerator} produced objects
 *
 * @group Functional
 * @coversNothing
 */
    ...
    public function skipPropertiesFixture(): array
    {
        return [
            ...
            [
                ...
                'property9',
                [
                    'skippedProperties' => ["\0ProxyManagerLtsTestAsset\\ClassWithPrivateProperties\0property9"],
                ],
                'property9',
            ],
            [
                ...
                'property0',
                [
                    'skippedProperties' => ["\0ProxyManagerLtsTestAsset\\ClassWithCollidingPrivateInheritedProperties\0property0"],
                ],
                'childClassProperty0',
            ],
            [
                ...
                'property0',
                [
                    'skippedProperties' => ["\0ProxyManagerLtsTestAsset\\ClassWithPrivateProperties\0property0"],
                ],
                'property0',
            ],
        ];
