...
use ProxyManagerLtsTestAsset\ClassWithPublicArrayPropertyAccessibleViaMethod;
...
/**
 * Tests for {@see \ProxyManagerLts\ProxyGenerator\AccessInterceptorScopeLocalizerGenerator} produced objects
 *
 * @group Functional
 * @coversNothing
 */
