...
/**
 * Tests for {@see \ProxyManagerLts\ProxyGenerator\AccessInterceptorScopeLocalizer\MethodGenerator\BindProxyProperties}
 *
 * @covers \ProxyManagerLts\ProxyGenerator\AccessInterceptorScopeLocalizer\MethodGenerator\BindProxyProperties
 * @group Coverage
 */
...
}, $this, 'ProxyManagerLtsTestAsset\\ClassWithMixedProperties')->__invoke();
...
$this->post = $suffixInterceptors;',
    ...
    public function testBodyStructureWithPrivateProperties(): void
    {
        ...
        self::assertSame(
            '\Closure::bind(function () use ($localizedObject) {
    $this->property0 = & $localizedObject->property0;
}, $this, \'ProxyManagerLtsTestAsset\\\\ClassWithPrivateProperties\')->__invoke();
...
}, $this, 'ProxyManagerLtsTestAsset\\ClassWithMixedReferenceableTypedProperties')->__invoke();
