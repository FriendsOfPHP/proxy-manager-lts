...
/**
 * Tests for {@see \ProxyManagerLts\ProxyGenerator\Util\Properties}
 *
 * @covers \ProxyManagerLts\ProxyGenerator\Util\Properties
 * @group  Coverage
 */
final class PropertiesTest extends TestCase
{
    ...
    {
        $propertyName = "\0ProxyManagerLtsTestAsset\\ClassWithCollidingPrivateInheritedProperties\0property0";
    ...
    public function propertiesToSkipFixture(): array
    {
        return [
            ...
            ["\0ProxyManagerLtsTestAsset\\ClassWithMixedProperties\0privateProperty0"],
        ];
    }
